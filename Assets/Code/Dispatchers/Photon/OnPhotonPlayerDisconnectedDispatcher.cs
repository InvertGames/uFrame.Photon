...
{
	[UFrameEventDispatcher("On Photon Player Disconnected"), uFrameCategory("Photon")]
	public class OnPhotonPlayerDisconnectedDispatcher : EcsDispatcher, IPunCallbacks
	{

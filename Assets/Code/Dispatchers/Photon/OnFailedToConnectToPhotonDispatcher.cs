...
{
	[UFrameEventDispatcher("On Failed To Connect To Photon"), uFrameCategory("Photon")]
	public class OnFailedToConnectToPhotonDispatcher : EcsDispatcher, IPunCallbacks
	{

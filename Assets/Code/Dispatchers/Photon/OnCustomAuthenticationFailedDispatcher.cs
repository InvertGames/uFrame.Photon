...
{
	[UFrameEventDispatcher("On Custom Authentication Failed"), uFrameCategory("Photon")]
	public class OnCustomAuthenticationFailedDispatcher : EcsDispatcher, IPunCallbacks
	{

...
{
	[UFrameEventDispatcher("On Photon Custom Room Properties Changed"), uFrameCategory("Photon")]
	public class OnPhotonCustomRoomPropertiesChangedDispatcher : EcsDispatcher, IPunCallbacks
	{

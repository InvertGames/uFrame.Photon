...
{
	[UFrameEventDispatcher("On Photon Player Properties Changed"), uFrameCategory("Photon")]
	public class OnPhotonPlayerPropertiesChangedDispatcher : EcsDispatcher, IPunCallbacks
	{
